        ...
        onClient && (
          <>
            ...
            {window.ethereum && !isActive && (
              <button
                className="border font-space flex items-center justify-center font-bold uppercase rounded-md text-dark-green w-[110px] xl:text-sm h-[34px] border-[#E5D540] xl:w-[160px] xl:h-[44px] text-[10px] hover:opacity-[0.6]"
                onClick={() => connect()}
              >
                Connect Wallet
              </button>
