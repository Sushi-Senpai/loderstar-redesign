              ...
              {signer &&
                ...
                (validationDetail === "Insufficient liquidity" ? (
                  ...
                  (
                    ...
                    <button className="flex items-center justify-center h-[50px] md:h-[60px] text-black font-space font-bold text-base sm:text-lg rounded w-full bg-[#E69E40] hover:bg-[#00e1ffd0]">
                      BORROW
                    </button>
                  )
                ))}
