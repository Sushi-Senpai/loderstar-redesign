                ...
                <>
                  {isGlpCoolingdown ? (
                    ...
                    <button
                      ...
                      className="uppercase flex items-center justify-center h-[50px] md:h-[60px] text-center text-black font-space font-bold text-base sm:text-lg rounded bg-[#E5D540] hover:bg-[#E5D540ce] w-full"
                    >
